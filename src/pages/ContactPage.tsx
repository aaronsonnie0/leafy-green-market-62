      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <Card className="text-center h-full">
              <CardContent className="pt-6">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-leaf-100 text-leaf-600">
                  <Mail className="h-6 w-6" />
                </div>
                <h3 className="text-lg font-medium mb-2">Email Us</h3>
                <p className="text-gray-500 mb-2">Our friendly team is here to help.</p>
                <a href="mailto:hello@greensandpots.com" className="text-leaf-600 hover:text-leaf-700 font-medium">
          ...
          >
            <Card className="text-center h-full">
              <CardContent className="pt-6">
                ...
                <a href="tel:+1234567890" className="text-leaf-600 hover:text-leaf-700 font-medium">
                  +1 (234) 567-890
                </a>
              </CardContent>
            </Card>
          ...
          >
            <Card className="text-center h-full">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-500 mb-2">Come say hello at our store.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <motion.div
            ...
            className="bg-leaf-50 rounded-lg p-6 border border-leaf-100"
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Button type="submit" className="bg-leaf-600 hover:bg-leaf-700 flex gap-2 items-center">
                <Send size={16} />
                Send Message
              </Button>
            </form>
        ...
        <motion.div
          ...
          className="bg-soil-50 rounded-lg p-8 text-center"
        >
          ...
          <div className="flex justify-center gap-6">
            <a href="#" className="text-soil-600 hover:text-soil-800 transition-colors">
